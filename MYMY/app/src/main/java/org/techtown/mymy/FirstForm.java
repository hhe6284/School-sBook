...
//        final View dialogView = inflater.inflate(R.layout.modify_timetable, null);
//        dialogBuilder.setView(dialogView);
//
//        final EditText mon_1 = (EditText) dialogView.findViewById(R.id.mon_1);
...
//            @Override
//            public void onClick(View view) {
//                String name = mon_1.getText().toString().trim();
...
//    private boolean updateArtist(String mon_1) {
//        setContentView(R.layout.school_1);
//        Intent intent = getIntent();
//        String code  = intent.getStringExtra("code");
//
//        //getting the specified artist reference
//        DatabaseReference dR = FirebaseDatabase.getInstance().getReference("new Group");
//
//
//        //updating artist
//        Artist artist = new Artist(mon_1);
//        dR.setValue(artist);
